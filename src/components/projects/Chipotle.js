    ...
    return (
        ...
        <div className="details-container">
            ...
            <section className="details-images">
                <img src="/project-images-large/chipotle-0.jpg" alt="Chipotle Project Start screen" /><br />
                <img src="/project-images-large/chipotle-1.jpg" alt="Chipotle Project preliminary information screen" /><br />
                <img src="/project-images-large/chipotle-2.jpg" alt="Chipotle Project - example of selecting a type of product" /><br />
                <img src="/project-images-large/chipotle-3.jpg" alt="Chipotle Project - example of selecting multiple locales" /><br />
            </section>
        </div>
        </>
    )
